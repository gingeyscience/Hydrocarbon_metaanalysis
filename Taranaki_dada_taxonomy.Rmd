...
# Assign taxonomy
tax <- assignTaxonomy(seqtab.nochim, "~/databases/silva_nr99_v138.1_train_set.fa", tryRC = TRUE, multithread=TRUE, minBoot = 80, outputBootstraps = TRUE) 
taxa <- assignTaxonomy(seqtab.nochim, "~/databases/silva_nr99_v138.1_train_set.fa", tryRC = TRUE, multithread=TRUE, minBoot = 80, outputBootstraps = F) 
...
seqs <- readDNAStringSet( "~/03_tabletax/repset_species_no_phylum.fasta")
...
alignment <- read.phyDat("~/03_tabletax/aligned_species.fasta", format = "fasta", type = "DNA")
